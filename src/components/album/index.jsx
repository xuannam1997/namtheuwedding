...
const AlbumImage = () => {
  ...
  const handleClickShowAlbum = () => {
    setOpenDialog(true);
  };

  const handleClickHideAlbum = () => {
    setOpenDialog(false);
  };
  ...
  return (
    <>
        ...
        <div className="container mx-auto">
          ...
          <div className="mt-10 mx-5">
            ...
            <div className="w-full relative md:hidden sm:block min-h-[400px]">
              ...
              <div className="absolute w-[88px] h-[95px] bottom-10 left-10 bg-[#EAEAEA] z-20 flex items-center justify-center rounded-l rounded-bl rounded-r-xl rounded-br-xl shadow before:absolute before:w-[1px] before:h-full before:bg-zinc-300 before:top-0 before:left-2 pl-2">
                <div
                  className="w-[65px] h-[65px] rounded-full flex items-center justify-center border border-zinc-300/80 relative"
                  onClick={handleClickShowAlbum}
                >
                  <span className="text-center z-20 text-white drop-shadow text-sm">
                    Xem album
                  </span>
                  <Image
                    src="/images/image_4.jpg"
      ...
      {openDialog && (
        <dialog id="album-modal" className="modal" open>
          <div className="modal-box w-full h-full max-w-none max-h-none rounded-none p-0">
            <form
              method="dialog"
              className="flex justify-between sticky top-0 px-6 py-3 backdrop-blur-lg bg-white/70 shadow"
            >
              <h3 className="font-normal text-base leading-[32px]">
                Album ảnh cưới
              </h3>
              <button
                className="btn btn-sm btn-circle btn-ghost"
                onClick={handleClickHideAlbum}
              >
                ✕
              </button>
            </form>
