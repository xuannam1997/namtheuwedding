          ...
          <div className="flex flex-col-reverse lg:flex-row gap-5 md:gap-20 items-stretch md:items-center p-5 py-10 md:p-20 md:py-24 z-20">
            ...
            <div>
              <div className="rounded-lg backdrop-blur-sm bg-white/30 p-5 flex flex-col items-center max-w-[620px]">
                ...
                <div className="mt-7 text-xl leading-9 text-left flex flex-col items-start w-full">
                  <p>Được tổ chức vào lúc: 17 giờ 00 phút</p>
                  <p>Thứ 6 ngày 19 / 01 / 2024</p>
                  <p>Địa chỉ: Đình làng Dương Lôi, Từ Sơn, Bắc Ninh</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr] gap-5 mt-7">
                ...
                <a
                  ...
                  target="_blank"
                  href="https://maps.app.goo.gl/F6ZtKeUmB77QGANm9"
                >
                  <Image
                    src="/images/theu_map.png"
                    alt=""
