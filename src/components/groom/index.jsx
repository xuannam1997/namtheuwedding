      ...
      <div className="mt-10 text-white">
        <div className="container hero relative m-auto">
          ...
          <div className="flex flex-col-reverse lg:flex-row gap-5 md:gap-20 items-stretch md:items-center p-5 py-10 md:p-20 md:py-24 z-20">
            ...
            <div>
              <div className="rounded-lg backdrop-blur-sm bg-white/30 p-5 flex flex-col items-center max-w-[620px]">
                ...
                <div className="mt-7 text-xl leading-9">
                  <p>Được tổ chức vào lúc:</p>
                  <p>18 giờ 00 phút thứ 6 ngày 19 / 01 / 2024</p>
                  <p>11 giờ 30 phút thứ 7 ngày 20 / 01 / 2024</p>
                  <p className="text-xl leading-9 text-left flex flex-col items-start w-full">
                    Địa chỉ: Số nhà 90 đường liên xã số 1 - Thuần Nhất - Phú Lộc
                    - Hậu Lộc - Thanh Hoá
                  </p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-[1fr_1fr] gap-5 mt-7">
                ...
                <div className="mt-1">
                  <a
                    ...
                    target="_blank"
                    href="https://docs.google.com/spreadsheets/d/10-2X-sTuwj-jt21HbG6ylWZWeaZtXZqcm4aiWP7MPnU/edit#gid=0"
                  >
