  ...
  return (
    ...
    >
      <div className="container m-auto flex flex-col lg:grid lg:grid-cols-[1fr_1fr] md:gap-10 gap-0 items-center">
        <div className="xl:h-[544px] md:h-[572px] h-[472px] w-full bg-white">
          <div className="p-5 md:px-10 md:py-12 backdrop-blur-lg bg-white/30 md:border border-[#F3ECE9] md:rounded h-full">
            <div className="flex flex-col justify-center items-center gap-3 px-5 mb-10">
              ...
              <p className="md:text-lg text-zinc-500 text-center mt-2">
                Hãy gửi lời chúc tới Hoàng Nam & Xuân Thêu ❤️
              </p>
            </div>
        ...
        <div className="xl:h-[544px] h-[572px] w-full bg-white">
            ...
            {greetings.map((greeting) => {
              ...
              return (
                <div key={_id} className="flex items-start mt-6">
                  ...
                  <div className="ml-5 flex flex-col flex-wrap break-words">
